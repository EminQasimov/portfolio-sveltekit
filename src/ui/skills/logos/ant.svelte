<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
	<defs>
		...
		<linearGradient id="d" x1="68.128%" x2="30.44%" y1="-35.691%" y2="114.943%">
	...
	<g fill="none">
		...
		<path
			fill="url(#c)"
			d="M196.647 173.754c5.408 5.404 14.176 5.404 19.584 0l34.739-34.71a15.396 15.396 0 000-21.812l-35.041-34.89c-5.421-5.397-14.192-5.389-19.603.018-5.408 5.404-5.408 14.164 0 19.568l23.667 23.648c1.503 1.502 1.503 3.781 0 5.283l-23.346 23.327c-5.408 5.404-5.408 14.165 0 19.568z"
		/>
